...
const words = {
  ja: {
    ...
    noBookmarks: "My skillsや学習ノートで「次の機会に」を選ぶと、ここに残ります。今は仕事を進めるだけでも構いません。",
    moreBookmarks: "件のしおりがあります。CLIのMy skillsとNext timeで全体を開けます。",
  ...
  en: {
    ...
    noBookmarks: "Choose Next time in My skills or a learning note. For now, simply continuing your work is enough.",
    moreBookmarks: "bookmarks in total. Open My skills and Next time in the CLI to see all your choices.",
